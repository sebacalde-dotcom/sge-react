...
- **La app sirve a más de un régimen de asistencia** (CABA y Provincia de Buenos Aires tienen reglas distintas). Todo es configurable en Configuración de Inasistencias, y `inasistencias/regimenes.ts` trae plantillas precargadas (tipos, reglas de regularidad, avisos). Hoy hay un régimen por escuela.
...
- **Ciclo Lectivo:** secciones con sus cursos adentro (hoy son dos pestañas); pestañas Materias y Horario, con el horario generado por IA. Materias alimenta "Materias que cursa" de la Ficha académica.
